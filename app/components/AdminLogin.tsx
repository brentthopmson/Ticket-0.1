        ...
        <div className="min-h-screen flex flex-col bg-white">
            ...
            <header className="h-[60px] border-b border-gray-200 flex items-center px-6 bg-white z-50">
                <div className="flex items-center">
                    <svg xmlns="http://www.w3.org/2000/svg" width="150" height="20" viewBox="0 0 160 25">
            ...
            <main className="flex-grow flex flex-col md:flex-row overflow-y-auto">
                ...
                <div className="hidden md:flex md:w-[45%] bg-[#026CDF] flex-col justify-between p-12 text-white relative overflow-hidden">
                    ...
                    <div className="z-10 flex items-center">
                        <svg xmlns="http://www.w3.org/2000/svg" width="120" height="16" viewBox="0 0 160 25" className="opacity-80">
