        ...
        <div className="bg-white rounded-3xl shadow-2xl overflow-hidden text-center p-8 md:p-12 border border-gray-100">
          ...
          <div className="space-y-6">
            ...
            <div className="bg-gray-50 p-4 rounded-2xl border border-gray-100">
               ...
               <p className="text-sm text-gray-700">Please contact the sender and request a new secure transfer link via Ticketmaster.</p>
            </div>
            ...
            <div className="pt-4 space-y-3">
              ...
              <p className="text-[10px] text-gray-400 font-bold uppercase tracking-widest">
                Protected by Ticketmaster FanProtect Guarantee
              </p>
            </div>
          </div>
        </div>
