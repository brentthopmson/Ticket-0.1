        ...
        <div className="min-h-screen bg-[#f4f7f9] flex flex-col font-sans pt-[72px]">
            ...
            <header className="bg-white text-[#001B41] border-b border-gray-100 px-4 py-3 fixed top-0 left-0 right-0 z-50 shadow-2xl">
                ...
                <div className="flex justify-between items-center">
                    ...
                    <button className="w-10 h-10 bg-white/10 rounded-full flex items-center justify-center text-white relative">
                        <FontAwesomeIcon icon={faUser} />
                        <div className="absolute -top-1 -right-1 w-5 h-4 bg-white rounded-sm overflow-hidden border border-white/20">
