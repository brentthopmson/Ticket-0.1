                        ...
                        <div className="flex bg-gray-100 dark:bg-gray-700 rounded-lg p-1">
                            ...
                            {admin?.role === 'OWNER' && (
                                <button
                                    ...
                                    className={`px-4 py-2 rounded-md flex items-center font-bold text-sm ${activeTab === 'customers' ? 'bg-[#026CDF] text-white shadow-md' : 'text-gray-500 hover:text-gray-700'}`}
                                >
