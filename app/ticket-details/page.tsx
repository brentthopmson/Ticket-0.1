...
export default function TicketDetails() {
  ...
  const handleAcceptTicket = useCallback(() => {
    // Only allow approval if not already processed
  ...
  const handleDeclineTransfer = useCallback(() => {
    // Only allow decline if not already processed
    if (user?.approvalSTAMP) return;
  ...
  // Check if ticket has been processed (either approved or declined)
  // This will be true if either:
  // 1. The user already had acceptSTAMP when the page loaded
  // 2. The user just approved/declined during this session
              ...
              {isTicketProcessed ? (
                ...
                <div className="mb-6 p-4 bg-blue-50 border border-blue-200 rounded-lg">
                  <div className="flex items-center mb-4">
                    ...
                    <div>
                      <h3 className="font-bold text-lg">Ticket Transfer</h3>
              ...
              <div className="space-y-6">
                    ...
                    <ul className="space-y-2">
                      ...
                      <li className="flex items-start">
                        ...
                        <div>
                          ...
                          <p className="text-gray-600">{user.eventStatus || "Confirmed"}</p>
                        </div>
                      </li>
                    </ul>
                  </div>
                ...
                {user.terms && (
                  <div>
                    ...
                    <p className="text-gray-600 text-sm">{user.terms}</p>
                  </div>
                )}
              </div>
            </div>
